...
print("Select rows for one condition")
print(df[df["Salary"]>50000])

print("Select rows for Multiple conditions")
print(df[(df["Salary"]>50000) & (df['Age']>50) ])

print("Select rows for Multiple conditions")
print(df[ (df['Age']>50) | (df['Perfomance Score']>90)])
